...
<img src="https://skillicons.dev/icons?i=js,html,css,arduino,py,kali,cpp,graphql,aws,bash,linux,docker,electron,git,mongodb,nodejs,react,svelte,threejs,ts,vite,powershell,postgres,mysql&perline=12">
